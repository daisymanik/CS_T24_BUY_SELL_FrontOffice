...
public class BuyOrder extends Basesetupdriver {
	...
	public void orderDetails() throws Throwable, Throwable {
		...
		Commonmethods.sendKeys(Basesetupdriver.driver.findElement(Openorder.transactioncode),
				read.readexcel().getField("transactioncode"));
		...
		Thread.sleep(minWait);
		System.out.println("Enter Buy Order Details : Successful");
	}
	...
	public void approveBuyFrontOfficeTxn() throws InterruptedException {
		Set<String> parentwindow5 = driver.getWindowHandles();
		int cnt5 = 0;
		for (String newwindow5 : parentwindow5) {
			driver.switchTo().window(newwindow5);
		...
		System.out.println("------------------------------------------------------------");
		System.out.println("Buy Order processed : Successful");
